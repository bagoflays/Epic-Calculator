...
btn_equal = tk.Button(root, text="=", command=_evaluate_calculation, width=5, font=("Arial", 14))
btn_equal.grid(row=6, column=2)
btn_clean = tk.Button(root, text="C", command=_clear_field, width=5, font=("Arial", 14))
btn_clean.grid(row=6, column=1)
root.mainloop()